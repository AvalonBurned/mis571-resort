package com.example.resortmanagement.view;
...
{
    public
    TableView(Context context, String tableName)
    {
        super
                (context);
        String sql = "select * from " + tableName + ";";
        DBOperator op = DBOperator.
                getInstance
                        ();
        ...
        this
                .extractData(context, cursor);
    }
    public
    TableView(Context context, Cursor cursor)
    {
        super
                (context);
        this
    ...
    private
    void
    extractData(Context context,Cursor cursor)
    {
        TextView textView;
        TableRow row;
        boolean
